        ...
        <div class="col-sm-8 blog-main">
            <form class="form-horizontal" action="/user/5/setting" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input class=" file-loading preview_input" type="file" value="用户名" style="width:89px" name="avatar">
                        <img  class="preview_img" src="image/user.jpeg" alt="正在拼命加载中..." class="img-rounded" style="border-radius:500px;">
                    </div>
                </div>
